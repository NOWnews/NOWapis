...
module.exports = {
    ...
    newsMongoDb: process.env.NODE_ENV === 'production' ? 'mongodb://nowproduction:werocks@TXGmongo-s185.nownews.com.tw,mongodb-s14.nownews.com.tw/production?readPreference=nearest&replicaSet=nowgarden' : 'mongodb://nowproduction:werocks@61.220.58.2/production',
