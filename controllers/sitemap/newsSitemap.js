...
module.exports = (req, res, next) => {
    ...
    let lastDay = moment(Date.now()).add(-2, 'day').format('X');
    ...
    co(function*() {
        ...
        let sitemapData = _.map(allNodes, (news) => {
            ...
            obj.name = 'NOWnews 今日新聞';
            obj.language = 'zh-tw';
            obj.genres = 'PressRelease, UserGenerated';
            obj.publication_date = moment(news.changed * 1000).format('YYYY-MM-DD');
