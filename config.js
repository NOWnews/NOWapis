...
module.exports = {
    ...
    newsMongoDb: process.env.NODE_ENV === 'production' ? 'mongodb://nowproduction:werocks@192.168.10.182/production' : 'mongodb://nowproduction:werocks@mongodb14.nownews.com.tw/production',
